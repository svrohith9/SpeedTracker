...
export const SettingsScreen: React.FC = () => {
    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-body antialiased transition-colors duration-200 h-full min-h-screen overflow-y-auto">
            <div className="relative flex h-auto min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto">
                ...
                <header className="sticky top-0 z-50 flex items-center bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-md px-4 py-3 justify-between">
                    <button 
                        onClick={() => navigate(-1)}
                        className="flex items-center gap-1 text-primary hover:opacity-70 transition-opacity -ml-2 px-2 py-1 select-none"
                    >
                    ...
                    <h2 className="text-[17px] font-semibold leading-tight flex-1 text-center absolute left-1/2 -translate-x-1/2 font-display">Settings</h2>
                ...
                <main className="flex-1 pb-12 pt-2 px-4">
                        ...
                        <div className="overflow-hidden rounded-xl bg-surface-light dark:bg-surface-dark">
                            <div className="flex items-center justify-between px-4 py-3 border-b border-separator-light/30 dark:border-separator-dark">
                                ...
                                <div className="flex bg-gray-100 dark:bg-black/30 p-0.5 rounded-lg select-none">
                                    <label className="cursor-pointer" onClick={() => updateSettings({ unit: 'MPH' })}>
                                    ...
                                    <label className="cursor-pointer" onClick={() => updateSettings({ unit: 'KMH' })}>
                            ...
                            <div className="flex items-center justify-between px-4 py-3">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input checked={settings.highPrecision} onChange={() => updateSettings({ highPrecision: !settings.highPrecision })} className="sr-only peer" type="checkbox"/>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="overflow-hidden rounded-xl bg-surface-light dark:bg-surface-dark divide-y divide-separator-light/30 dark:divide-separator-dark">
                            <button className="w-full flex items-center justify-between px-4 py-3 active:bg-gray-100 dark:active:bg-gray-800 transition-colors">
                            ...
                            <div className="flex items-center justify-between px-4 py-3">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input checked={settings.stabilization} onChange={() => updateSettings({ stabilization: !settings.stabilization })} className="sr-only peer" type="checkbox"/>
                                    <div className="w-[51px] h-[31px] bg-[#E9E9EA] peer-focus:outline-none rounded-full peer dark:bg-[#39393D] peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-[27px] after:w-[27px] after:transition-all dark:border-gray-600 peer-checked:bg-[#34C759]"></div>
                                </label>
                            </div>
                        </div>
                    ...
                    <div className="mt-8">
                        ...
                        <div className="overflow-hidden rounded-xl bg-surface-light dark:bg-surface-dark divide-y divide-separator-light/30 dark:divide-separator-dark">
                            <div className="flex items-center justify-between px-4 py-3">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer">
                                    <input checked={settings.autoDetect} onChange={() => updateSettings({ autoDetect: !settings.autoDetect })} className="sr-only peer" type="checkbox"/>
                                    <div className="w-[51px] h-[31px] bg-[#E9E9EA] peer-focus:outline-none rounded-full peer dark:bg-[#39393D] peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-[27px] after:w-[27px] after:transition-all dark:border-gray-600 peer-checked:bg-[#34C759]"></div>
                                </label>
                            </div>
